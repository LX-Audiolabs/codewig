...
1. **YAML present** → device is listed in the UI Devices tab and is param-aware (even if `params: {}`).
2. **No file** → insert may still work (open Bitwig resolve); **not listed** in UI; **params unsupported**.
